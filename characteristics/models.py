...
class ProductType(models.Model):
    ...
    icon = models.ImageField(upload_to="icons/Data%y/%m/%d/", null=True, blank=True)

    photo = models.ImageField(upload_to="category/Data%y/%m/%d/", null=True, blank=True)
...
class CountryMade(models.Model):
    ...
    flag = models.ImageField(
        upload_to="country_made_flags/Data%y/%m/%d/", null=True, blank=True
    )
    slug = models.SlugField(
        max_length=255, unique=True, db_index=True, verbose_name="URL", null=True
    )
...
class CountryBrand(models.Model):
    ...
    name = models.CharField(max_length=255)
    flag = models.ImageField(
        upload_to="country_brand__flags/Data%y/%m/%d/", null=True, blank=True
    )
    slug = models.SlugField(
        max_length=255, unique=True, db_index=True, verbose_name="URL", null=True
    )
