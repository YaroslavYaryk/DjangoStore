...
def get_result_according_to_parameters(queryset, get_queryset, order_query):
    if order_query:
        return queryset.order_by(order_query), 1
    if get_queryset:
        return queryset, 1
...
def get_characteristic_by_diagonal_screen( user,  characteristic_field, get_queryset=False, order_query=False):
    ...
    if get_result_according_to_parameters(queryset, get_queryset, order_query):
        return get_result_according_to_parameters(queryset, get_queryset, order_query)
    return get_categories_query_according_to_user(user, queryset), characteristic_field


def get_characteristic_by_screen_type(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
...
def get_characteristic_by_screen_frequency(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_processor(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_operation_system(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_memory_capacity(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_memory_slots(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_memory_type(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_hard_drive(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
...
def get_characteristic_by_video_card(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""

    
    queryset = Characteristics.objects.filter(video_card=characteristic_field)
    if get_result_according_to_parameters(queryset, get_queryset, order_query)[1]:
        return get_result_according_to_parameters(queryset, get_queryset, order_query)
    return get_categories_query_according_to_user(user, queryset), characteristic_field


def get_characteristic_by_video_card_memory(user,  characteristic_field, get_queryset=False, order_query=False):
    """ returns generated characteristic query there
        all products with <charact_slug> screen type"""
